...
class Article {
    ...
    */
    ...
    /**
     * Get the article record based on the ID along with associated categories, if any (is present)
     * 
     * @param object $conn Connection to the database
     * @param integer $id the article ID
     * 
    ...
    * 
    * @return boolean True if the current proprties are valid, false otherwise
    */
